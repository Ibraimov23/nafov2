...
export const Home = ({ siteTitle }) => {
	return (
		<div class="home-page" id="home">
			<div class="home-page__container _container" data-aos-duration="1000">
				<div class="home-page__descriptions">
					<h1 class="home-page__header header-text" data-aos="fade-up">$NAFO</h1>
					<p class="home-page__description" data-aos="fade-up">
					...
					<p class="home-page__info" data-aos="fade-up">$NAFO contract adress: <br />0xa39E0742901fC51245d786DC955E96C1D8d188a2</p>
				</div>
				<div class="home-page__soc-medias">
					<ul class="soc-medias__links" data-aos="fade-up">
